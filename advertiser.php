...
<head>
  ...
  <style type="text/css">
   ...
   .table, tr,th, td{
    ...
    .th_subj{
      color: #FFF; background: #333; text-align: center; font-weight:bold;       
    }
...
<center>
  ...
  <div class="dropdown">
    <button  style="width: 250px;" class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"> Physics Cycle 
  ...
  <table id="addTable" class="table">
    <thead>
      <tr style="background:#5cd65c;">
        ...
        <th class="th_subj" colspan="2">Machanics</th>
        <th class="th_subj" colspan="1">English</th>
        <th class="th_subj" colspan="2">Physics</th>
        <th class="th_subj" colspan="3">BEE</th>
      </tr>
